...
class __Mustache_b564d680cc8600d0d09a2d1b6a676c58 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section586d209eb9bc0bc3ff79879ae5ad6220($context, $indent, $context->findDot('page.members'));
        $buffer .= $indent . '</div>';
        $buffer .= "\n";
        $buffer .= $indent . '';
        $buffer .= "\n";
    ...
    private function section9be273acb3b3726ed6ec582af8257849(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section586d209eb9bc0bc3ff79879ae5ad6220(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
	...
	';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                // 'pending' section
                $buffer .= $this->section9be273acb3b3726ed6ec582af8257849($context, $indent, $context->find('pending'));
                // 'blocked' section
