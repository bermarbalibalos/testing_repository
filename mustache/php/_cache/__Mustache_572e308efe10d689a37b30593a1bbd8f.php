...
class __Mustache_572e308efe10d689a37b30593a1bbd8f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionCad7daee09a17ea8b23b092aa8b6d9d5($context, $indent, $context->findDot('page.comments'));
        $buffer .= $indent . '</div>';
        $buffer .= "\n";
        $buffer .= $indent . '';
        $buffer .= "\n";
    ...
    private function sectionE373a6881f668ac88195474cd5c3c166(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionCad7daee09a17ea8b23b092aa8b6d9d5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
	...
	';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                // 'menu' section
                $buffer .= $this->sectionE373a6881f668ac88195474cd5c3c166($context, $indent, $context->find('menu'));
