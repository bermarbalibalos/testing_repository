...
class __Mustache_ae4ed0fad87886e501de4326f047da01 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '';
        $buffer .= "\n";
        $buffer .= $indent . '		<div class="main-container container-fluid">';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '';
        $buffer .= "\n";
        $buffer .= $indent . '		<a href="#" id="btn-scroll-up" class="btn-scroll-up btn btn-small btn-inverse">';
        $buffer .= "\n";
